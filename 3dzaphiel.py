...
class Game(ShowBase):
    def __init__(self):
        ...
        self.model = self.loader.loadModel("zapkiel11.glb")
        self.model1 = self.loader.loadModel("zapkiel11.glb")
        ...
        self.model1.setScale(1)
        self.model1.setPos(50,0,50)

        self.camera_node = NodePath('camera_node')
        self.camera_node.reparentTo(self.render)
